...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument("--host", default=os.getenv("ES_HOST"), help="Elasticsearch host")
	parser.add_argument("--port", type=int, default=int(os.getenv("ES_PORT")), help="Elasticsearch port")
	parser.add_argument("--scheme", default=os.getenv("ES_SCHEME"), help="http or https")
	...
	parser.add_argument("--index", default=os.getenv("ES_TEST_INDEX", "es_access_test"), help="Test index")
